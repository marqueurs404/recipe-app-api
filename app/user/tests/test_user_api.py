...
class PublicUserApiTests(TestCase):
    """Test the users API (public, i.e. unauthenticated APIs)"""
    ...
    def test_retrieve_profile_unauthorized(self):
        """Test that authentication is required to retrieve user profile"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_profile_not_allowed(self):
        """Test that POST is not allowed on profile url"""
